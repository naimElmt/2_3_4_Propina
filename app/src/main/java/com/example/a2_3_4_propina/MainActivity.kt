package com.example.a2_3_4_propina
...
import com.example.a2_3_4_propina.ui.theme._2_3_4_PropinaTheme
...
fun TipTimeLayout() {
    ...
    Column(
        modifier = Modifier.statusBarsPadding().padding(horizontal = 40.dp)
